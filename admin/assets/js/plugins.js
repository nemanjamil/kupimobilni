	...
	var initDataTables = function() {
		if ($.fn.dataTable) {
			...
			$.extend(true, $.fn.dataTable.defaults, {
				...
				// pogledaj nemanjamil ovde smo promenili sa 5 na 200, prikaz 200 redova na tabelama.
				"iDisplayLength": 200,
				fnDrawCallback: function () {
					...
					search_input.attr('placeholder', 'Filtriraj tabelu');
			...
			$.fn.dataTable.defaults.aLengthMenu = [[5, 25, 50, 100, 200, 500, -1], [5, 25, 50, 100, 200, 500, "All"]];
