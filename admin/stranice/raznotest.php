        ...
        <div class="widget box">
            ...
            <div class="widget-content">
                <table class="table table-striped table-bordered table-hover datatable">
                    ...
                    // za brisanje svih Ariklala od USERA SA FOLDERO
                    $limit = Array(0, 500);
                    $cols = Array("*");
                    $db->where("ArtikalKomitent", 60);
                    $data = $db->get("artikli", $limit, $cols);
                    ...
                    if ($data) {
                        foreach ($data as $sds => $link) {
                            ...
                            // dali postoji folder
                            $lok = $common->locationslika($ArtikalId);
                            $lokslifol = DCROOT . $lok;


                            $files = glob($lokslifol.'/*'); // get all file names
                            ...
                            if($db->delete('artikli')) {
                                echo '<div><span><a href="">SVE JE OK '.$ArtikalId.' '.$lokslifol.'</a></span></div>';
                            } else {
                                echo '<div><span><a href="">NIJE OBRISAO '.$ArtikalId.' '.$lokslifol.'</a></span></div>';
                            }
