 ...
 */
$brendAgro = ($_POST['brendartikla']) ? $_POST['brendartikla'] : 51; // // AGRO BREND -  TEXELL
$vendorDodatna = ($_POST['vendorDodatna']) ? $_POST['vendorDodatna'] : 39; // DODATNA VENDOR - CTC UNIT
$vendorAgro = ($_POST['KomitentId']) ? $_POST['KomitentId'] : 117; // AGRO VENDOR - CTC UNIT
$brendDodatnaUpit = ($_POST['brendartikladodatna']) ? $_POST['brendartikladodatna'] : 665; // BREND DODATNA - TEXELL
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select id="brendartikladodatna" name="brendartikladodatna"  class="form-control required" value="<?php echo $brendDodatnaUpit;?>">
                                ...
                                $upitBrend = "SELECT b.brand_name, v.brend
                                FROM vebsop v
                ...
                <div>
                    ...
                    if ($db->count > 0) {
                        foreach ($users as $v) {
                            ...
                            $ctcunit = $v['ctcunit']; // od dodatneOprema je ova kolona

                            $codeGlavni = $ctcunit;
                            $codeSec = 'codectcunit'; // na Agro
