...
$katsrafovi = 11192;
$podstafovi = $db->rawQueryOne("SELECT svePodkat($katsrafovi) as svePodk");
$katsraf = rtrim($podstafovi['svePodk'], ",");
    ...
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i>TABLETI - pocetna stranica</h4>
            ...
            <div class="widget-content">
                ...
                <form enctype="multipart/form-data" method="post" class="form-horizontal row-border" id="validate-1"
                      action="/akcija.php?action=dodajalsrafovenapocetnu">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <select id="id" name="id"
                                ...
                                <option value=""></option>
                                <?php
                                $db->where('KategorijaArtikalId IN ('.$katsraf.')' );
