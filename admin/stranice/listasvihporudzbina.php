            ...
            <div class="widget-content">
                <table
                    ...
                    foreach ($data as $sds => $link) {
                        ...
                        $VremeNarudz = date( "d M H:i", strtotime( $VremeNarudz));
                        ...
                        $SinhronizovanoNarudz = $link[SinhronizovanoNarudz];
                        ...
                        /*if($SinhronizovanoNarudz == 0){
                            ...
                            $tab .= '<a onclick="return confirmSubmit()" href = "' . DPROOT . '/admin/str/sinhronizujdokument/' . $IdNarudzbine . '" > <button class="btn btn-warning"> Sinhronizuj </button ></a >';
                            $tab .= '</div >';
                            $tab .= '</td > ';
