...
<div class="col-md-12">
    <div class="widget box">
        <div class="widget-header">
            <h4><i class="icon-list-alt"></i> Lista proizvoda na pocetnoj SLIDER</h4>
        ...
        <div class="widget-content">
            <table class="table table-striped table-bordered table-hover table-checkable table-colvis datatable">
                ...
                $db->where("a.ArtikalNaAkciji", 1);
                $db->where("ANN.IdLanguage = 5 AND kn.IdLanguage = 5");
                $db->orderBy ("a.top1","asc");
                $data = $db->get("artikli a", null, " a.ArtikalId, ANN.OpisArtikla, a.ArtikalLink, a.ArtikalMPCena, a.ArtikalNaAkciji, a.top1, kn.NazivKategorije");
...
<div>
     <form enctype="multipart/form-data"  method="post" id="validate-1" action="/akcija.php?action=dodajpozicijusuper">
           ...
           <div>
                <select id="top1" name="top1" class="form-control " style="margin-bottom: 3px;">
