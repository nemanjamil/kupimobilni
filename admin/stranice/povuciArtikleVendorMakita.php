 ...
 */
$brendAgro = ($_POST['brendartikla']) ? $_POST['brendartikla'] : 35; // // AGRO BREND -  MAKIA
$vendorDodatna = ($_POST['vendorDodatna']) ? $_POST['vendorDodatna'] : 41; // DODATNA VENDOR - VERMAX
$vendorAgro = ($_POST['KomitentId']) ? $_POST['KomitentId'] : 54; // AGRO VENDOR - VERMAX
$brendDodatnaUpit = ($_POST['brendartikladodatna']) ? $_POST['brendartikladodatna'] : 702; // BREND DODATNA - MAKITA
