...
<div class="col-md-12">
    <div class="widget box">
        <div class="widget-header">
            <h4><i class="icon-list-alt"></i> Lista proizvoda NAJPRODAVANIJI</h4>
        ...
        <div class="widget-content">
            <table class="table table-striped table-bordered table-hover table-colvis datatable">
                <thead>
                <tr>
                    <th>Id</th>
                    <th>Pozicija</th>
