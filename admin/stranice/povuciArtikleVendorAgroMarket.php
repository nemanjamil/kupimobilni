 ...
 */
$brendAgro = ($_POST['brendartikla']) ? $_POST['brendartikla'] : 40; // marker villager
$vendorDodatna = ($_POST['vendorDodatna']) ? $_POST['vendorDodatna'] : 47; // dodatna oprema AgroMarket
$vendorAgro = ($_POST['KomitentId']) ? $_POST['KomitentId'] : 60; // AgroMarket komitent
                    ...
                    if ($db->count > 0) {
                        foreach ($users as $v) {
                            ...
                            */
                            ...
                            $user = $db->getOne ("ArtikliTekstovi");
                            $IdArtikliTekstovi = $user['IdArtikliTekstovi'];
