...
$brendAgro = ($_POST['brendartikla']) ? $_POST['brendartikla'] : 40; // AGRO BREND - villager
$vendorDodatna = ($_POST['vendorDodatna']) ? $_POST['vendorDodatna'] : 47; // DODATNA VENDOR - AgroMarket
$vendorAgro = ($_POST['KomitentId']) ? $_POST['KomitentId'] : 60; // AGRO VENDOR - AgroMarket
$brendDodatnaUpit = ($_POST['brendartikladodatna']) ? $_POST['brendartikladodatna'] : 708; // BREND DODATNA - Villager
        ...
        <div class="widget box">
            ...
            <div class="widget-content">
                ...
                <div>
                    ...
                    //$db->where("V.brend", 735); // dodali smo brend da bi dobili tu lisut
                    ...
                    if ($db->count > 0) {
                        foreach ($users as $v) {
                            ...
                            $pokazi .= '<ul>';
                                ...
                                $pokazi .= '<li>$CodeAgro : ' . $CodeAgro . '</li>';
