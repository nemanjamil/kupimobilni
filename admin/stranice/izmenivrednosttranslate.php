    ...
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i> Vrednost za <i>[<?php echo $ShortLanguage; ?>]</i></h4>
            ...
            <div class="widget-content">
                <div class="widget-content">
                    <form enctype="multipart/form-data" method="post" class="form-horizontal row-border"
                          id="validate-2" action="/akcija.php?action=izmenitranslatevrednost">
                        ...
                        foreach ($jezLan as $k => $v):
                            ...
                            $naziv .= '<label class="col-md-3 control-label bg-success"><strong>Opis Jezika ' . $srblat . ' </strong></label>';
                            $naziv .= '<div class="col-md-9">';
                            $naziv .= '<input type="hidden" id="IdJezik' . $ShortLanguage . '" name="IdJezik[' . $IdLanguage . ']" class="form-control" value="' . $IdLanguage1 . '">';
                        ...
                        echo $naziv;
                        ?>
                        <input type="hidden" id="IdTranslateVrd" name="IdTranslateVrd" class="form-control" value="<?php echo $IdTranslate ?>">
                        ...
                        <div class="form-actions">
                            <input type="submit" value="Izmeni" class="btn btn-primary pull-right">
                        </div>
                    </form>
