...
<div class="col-md-12">
    <div class="widget box">
        <div class="widget-header">
            <h4><i class="icon-list-alt"></i> Lista proizvoda pocetna NAJGLEDANIJI proizvodi</h4>
        ...
        <div class="widget-content">
            <table class="table table-striped table-bordered table-hover table-checkable table-colvis datatable">
                ...
                $db->where("a.ArtikalNaAkciji", 2);
                $db->where("ANN.IdLanguage = 5 AND kn.IdLanguage = 5");
                $db->orderBy ("a.top1","asc");
                $data = $db->get("artikli a", null, " a.ArtikalId, ANN.OpisArtikla, a.ArtikalLink, a.ArtikalMPCena, a.ArtikalNaAkciji, a.top2, kn.NazivKategorije");
                ...
                foreach ($data as $sds => $link) {
                    ...
                    $r .= '<tr>
                        ...
                        <td style="vertical-align: middle"><b>'.$top2.'</b></td>
                        <td style="vertical-align: middle">
                           <div class="btn-group">
<div>
     <form enctype="multipart/form-data" method="post" id="validate-1" action="/akcija.php?action=dodajpozicijunovi">
                <input type="hidden" value="'. $ArtikalId.'" id="id" name="id">

           <div>
                <select id="top2" name="top2" class="form-control" style="margin-bottom: 3px;">
