 ...
 */
$katalati = 11185;
$podaIn = $db->rawQueryOne("SELECT svePodkat($katalati) as svePodk");
...
<div class="row">
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i>Mobilni - pocetna stranica</h4>
            ...
            <div class="widget-content">
                ...
                <form enctype="multipart/form-data" method="post" class="form-horizontal row-border" id="validate-1"
                      action="/akcija.php?action=dodajalatiimasinenapocetnu">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <select id="id" name="id"
                                ...
                                $db->where('KategorijaArtikalId IN ('.$podIn.')' );
    ...
    <?php include 'lista-alatiimasine.php' ?>
</div>