...
<div class="row">
        ...
        <div class="widget box">
            ...
            <div class="widget-content">
                ...
                <form enctype="multipart/form-data" method="post" class="form-horizontal row-border" id="validate-1"
                      action="/akcija.php?action=dodajakcijanajprod">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="hidden" value="3" name="br" id="VrstaPonude">
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <input type="submit" value="Stavi na rasprodaju" class="btn btn-primary pull-right">
                    </div>
    ...
    <?php include 'listaartakcijanajprodA.php' ?>
</div>
