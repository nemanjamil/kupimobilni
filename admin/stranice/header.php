...
<header class="header navbar navbar-fixed-top" role="banner">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="/admin">
            <img src="<?php echo DPROOTADMIN . '/'; ?>assets/img/logo.png" alt="logo"/> <?php echo KOJIJESAJT;?>
        </a>
        <!-- /logo -->
        ...
        <ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="/admin/osnovnipodaciM"><i class="icon-download"></i>Osnovni podaci</a></li>
                    <!--<li><a href="/admin/txtnaslovna"><i class="icon-user"></i>Tekst naslovna</a></li>-->
                    <li class="divider"></li>
                    <li><a href="/admin/tagovi"><i class="icon-list-alt"></i>Tagovi</a></li>
                </ul>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <!-- <li class="dropdown user">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <i class="icon-male"></i>
                    <span class="username"><?php /*echo $KomitentNaziv*/ ?></span>
                    <i class="icon-caret-down small"></i>
                </a>
                <ul class="dropdown-menu">
