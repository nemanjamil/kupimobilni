...
<div class="row">
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i>Artikli na Super ponudi</h4>
                ...
                <form enctype="multipart/form-data" method="post" class="form-horizontal row-border" id="validate-1"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="hidden" value="6" name="br" id="VrstaPonude">
                    ...
                    <div class="form-actions">
                        <input type="submit" value="Stavi na super ponudu" class="btn btn-primary pull-right">
                    </div>
    ...
    <?php include 'listaartakcijaM.php' ?>
</div>
</div>