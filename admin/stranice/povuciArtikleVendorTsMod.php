 ...
 */
$brendAgro = ($_POST['brendartikla']) ? $_POST['brendartikla'] : 44; // // AGRO BREND -  Stanley
$vendorDodatna = ($_POST['vendorDodatna']) ? $_POST['vendorDodatna'] : 49; // DODATNA VENDOR - TS MOD
$vendorAgro = ($_POST['KomitentId']) ? $_POST['KomitentId'] : 61; // AGRO VENDOR - TS MOD
$brendDodatnaUpit = ($_POST['brendartikladodatna']) ? $_POST['brendartikladodatna'] : 715; // BREND DODATNA - Stanley
        ...
        <div class="widget box">
            ...
            <div class="widget-content">
                ...
                <form enctype="multipart/form-data" class="form-horizontal row-border" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select id="brendartikladodatna" name="brendartikladodatna"  class="form-control required" value="<?php echo $brendDodatnaUpit;?>">
                                ...
                                -- ,(SELECT COUNT(*) FROM vebsop vs WHERE vs.vendor = 49 AND vs.brend = v.brend)  AS kolikoKomada
                                FROM vebsop v
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Koliko ima artikala po kategoriji</label>

                        <div class="col-md-10">
                            <?php
                            require ('kolikoImaArtPoKategUbaci.php');
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Komitenti MASINE</label>
        ...
        <div class="widget box">
            ...
            <div class="widget-content">
                ...
                <div>
                    ...
                    if (!$brendAgro || !$vendorDodatna || !$vendorAgro || !$brendDodatnaUpit) {
                    ...
                    $db->where("V.brend", $brendDodatnaUpit); // dodali smo brend da bi dobili tu lisut
                    ...
                    if ($db->count > 0) {
                        foreach ($users as $v) {
                            ...
                            $codetsmod = $v['dobavljac3'];

                            $codeGlavni = $codetsmod;
                            $codeSec = 'codetsmod'; // na Agro
