    ...
    <div class="col-md-12 col-xs-6x">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-th-large"></i> Podaci po artiklu VEBSOP samo bosch-professional</h4>
...
<div class="row">
    <div class="col-md-12 col-xs-6x">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-sitemap"></i> Povuci Artikle Vendor - samo bosch-professional</h4>
            </div>
            <div class="widget-content">
                <div class="well">
                ...
                <div>
                    ...
                    echo '<br/> Ukupno Bosch Profesional -> ';
                    echo $db->count;
                    echo '<br/>';
                    if (!$users) {
                    ...
                    if ($db->count > 0) {
                        foreach ($users as $v) {
                            ...
                            if (!$kategorijaAgro) {
                                ...
                                echo $pokazi;
                                echo '<br/>';
                                echo 'Ne postoji $kategorijaAgro ';
                                die;
                            }


                            $pokazi .= '<ul style="background-color: #d1edff">';
                                require('insertPovuciArtBoschProf.php');
                            $pokazi .= '</ul>';
