...
$kojijevendor = 18;  // id u tabeli cronzaxml
$vendor = 63;  // u tabeli komitenti
$codetip = 'ArtikalSifra'; // koji je red za sifru u tabel artikli
$brend_code = 46; // tabela brendovi
...
$doc = new DOMDocument();
$doc->load(DCROOTADMINXML . '/xml/'.$folder.'/metabozimskaakcija.xml');
