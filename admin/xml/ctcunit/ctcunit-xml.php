...
$log->lwrite('OK CTCUNIT XML -> tip HOST '.$documentroot.'; ROOTLOC : '.ROOTLOC);

$kojijevendor = 7;  // id u tabeli cronzaxml
$vendor = 117;  // u tabeli komitenti
$codetip = 'codectcunit'; // koji je red za sifru u tabel artikli
$codetipLink = ''; // art za ubaciti link na AGRO
$codetipLinkDodatna = ''; // kolona na Dodatnoj opremi
$brend_code = 51; // tabela brendovi Texell
...
if ($kolikoimachild > $BrojDokle) {
    ...
    $log->lwrite('DOSAO DO 0 CTC UNIT XML');
    echo 'Nema vise';
    die;
}
...
$log->lwrite('KRAJ CTC UNIT XML '.$MenjanArtikal);
