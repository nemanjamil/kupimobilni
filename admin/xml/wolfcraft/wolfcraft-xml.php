...
$log->lwrite('OK WolfCraft XML -> tip HOST '.$documentroot.'; ROOTLOC : '.ROOTLOC);

$kojijevendor = 15;  // id u tabeli cronzaxml
$vendor = 53;  // u tabeli komitenti
$codetip = 'codelumen'; // koji je red za sifru u tabel artikli
$codetipLink = 'codelumenlink'; // art za ubaciti link na AGRO
$codetipLinkDodatna = 'codelumenlink'; // kolona na Dodatnoj opremi
$brend_code = 34; // tabela brendovi
...
$MinimalnaKolArt = 1; // minimalna kolicina koja moze da se naruci
$folder = 'wolfcraft';
...
if ($kolikoimachild > $BrojDokle) {
    ...
    $log->lwrite('DOSAO DO 0 WolfCraft XML');
    echo 'Nema vise';
    die;
}
...
$log->lwrite('KRAJ WolfCraft XML '.$MenjanArtikal);
