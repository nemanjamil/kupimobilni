...
$log->lwrite('OK VERMAX MAKITA DELOVI XML -> tip HOST '.$documentroot.'; ROOTLOC : '.ROOTLOC);
...
$dom->encoding = 'UTF-8';
$dom->save($documentroot.'/admin/xml/vermax/xmlovi/vermax_mak_delovi.xml');

$log->lwrite('CALLWINGS KRAJ VERMAX MAKITA DELOVI');
?>