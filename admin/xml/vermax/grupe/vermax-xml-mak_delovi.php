...
$log->lwrite('OK VERMAX MAKITA DELOVI -> tip HOST '.$documentroot.'; ROOTLOC : '.ROOTLOC);

$kojijevendor = 19;  // id u tabeli cronzaxml @vermax delovi@
...
if ($kolikoimachild > $BrojDokle) {
    ...
    $log->lwrite('DOSAO DO 0 VERMAX DELOVI MAK XML');
    echo 'Nema vise';
    die;
}
...
$log->lwrite('KRAJ VERMAX MAKITA DELOVI XML '.$MenjanArtikal);
