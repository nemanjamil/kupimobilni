...
$kaL = '';
//$upitKateg = "CALL listaKategorijaPoListiIdNew('" . KATEGORIJESAJTCRON . "',$jezik,$tipUsera,0,25)";
...
if ($katspGlavne) {
    foreach ($katspGlavne AS $kay => $val) {
        ...
        $kaL .= '<li><a href="/'.$KategorijaArtikalaLinkMM.'">'.$KategorijaArtikalaNazivMM.'<span class="item-count"><i class="fa fa-angle-double-right"></i> </span> </a></li>';
...
$fp = fopen(DCROOT . '/cron/crongotovo/kategorijecron-create-kupimobilni.php', 'w+');
fwrite($fp, $kaL);
fclose($fp);
