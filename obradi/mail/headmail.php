...
$bodyMail .= '<head>
    ...
    <title>'. $jsonlang[271][$jezikId] . ' '.$idNar.'</title>
    ...
    <style type="text/css">
        ...
        ul {margin: 0px; padding: 4px 0;}
        table[id="artikli"] td, table[id="artikli"] th {   border: 1px solid #dedede; text-align: left; color: #404040 }
        table[id="artikli"] a { color:#2C9AB7; }
