...
<?php
function displayListProduct($productName,$is_new,$is_sale,$is_hot,$productImageURL, $oldPrice = 400.99 ,$price = 369.99, $score = 4){
?>
		...
		<div class="col-md-8 col-sm-7 col-xs-12">
			<div class="product-info">
				...
				<div class="product-short-desc">
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labo re et dolore magna aliqua. Ut enim ad minim venia. Lorem ipsum dolor sit amet, conse ctetur adi piscing elit send do eiusmod later.</p>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button">
							<a class="btn btn-primary" href="index.php?page-detail">Add to cart</a>
						</li>
