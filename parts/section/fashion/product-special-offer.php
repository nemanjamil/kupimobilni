<?php
$katalatimasine = KATALATIMASINE;
$podaIn = $db->rawQueryOne("SELECT svePodkat($katalatimasine) as svePodk");
...
$footArtiPoc = "
SELECT *,
(CASE WHEN KomitentUPdv = 1
THEN getkursorg * (ArtikalMPCena - mpjac) * MarzaMarza * (PorezVrednost/100 + 1)
ELSE getkursorg * (ArtikalMPCena - mpjac) * MarzaMarza END) AS pravaMp,

(CASE WHEN KomitentUPdv = 1
THEN getkursorg *(ArtikalVPCena - vpjac)* MarzaVP * (PorezVrednost/100 + 1)
ELSE getkursorg * (ArtikalVPCena -  vpjac)  * MarzaVP END) AS pravaVp
FROM (
SELECT
A.ArtikalId,
A.ArtikalNaAkciji,
...
<div class="product-item-small">
	<h3 class="section-title"><?php echo $jsonlang[377][$jezikId]; ?></h3>
