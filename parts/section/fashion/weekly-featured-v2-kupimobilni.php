<!-- ============================================== WEEKLY FEATURED-V2 - Kupimobilni ============================================== -->
...
<div class="fashion-v6-featured">
    ...
    $limitUpit = 8;
    $brojAkcije = "";
    $upitArtArray = "CALL listaArtikalaRazno($limitUpit,$valutasession,$jezikId,$KomitentId,'1');";
...
//var_dump($products);
    ...
    <div class="item category-product">
        <div class="products grid-v4 wow fadeInUp nopaddingnomargin" data-wow-delay="<?php echo (float)($delay/50);?>s">
