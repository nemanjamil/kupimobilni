	...
	<div class="product-item-sm ">
		<div class="media products-small">
			<div class="media-left product-image">
				<a href="#"><img src="assets/images/products/87.jpg" class="img-responsive" alt=""></a>
			</div>
		...
		<div class="media products-small">
			<div class="media-left product-image">
				<a href="#"><img src="assets/images/products/88.jpg" class="img-responsive" alt=""></a>
			</div>
			<div class="media-body product-info">
				<h5><a href="#">Product name #01</a></h5>
		...
		<div class="media products-small">
			<div class="media-left product-image">
				<a href="#"><img src="assets/images/products/89.jpg" class="img-responsive" alt=""></a>
			</div>
			<div class="media-body product-info">
				<h5><a href="#">Product name #01</a></h5>
