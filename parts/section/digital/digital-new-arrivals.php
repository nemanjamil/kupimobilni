		...
		<div class="item">
			<div class="row products-small">
				<div class="col-md-4 col-xs-4 product-image">
					<a href="#"><img src="assets/images/products/48.jpg" class="img-responsive" alt=""></a>
				</div>
			...
			<div class="row products-small">
				<div class="col-md-4 col-xs-4 product-image">
					<a href="#"><img src="assets/images/products/49.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-md-8 col-xs-8 product-info">
					<h5><a href="#">Product name #01</a></h5>
			...
			<div class="row products-small">
				<div class="col-md-4 col-xs-4 product-image">
					<a href="#"><img src="assets/images/products/50.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-md-8 col-xs-8 product-info">
					<h5><a href="#">Product name #01</a></h5>
