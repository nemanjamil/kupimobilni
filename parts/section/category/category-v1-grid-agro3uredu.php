                    ...
                    <div class="product-image">
                        <div>
                            <a href="<?php echo $urlArtiklaLink; ?>"> <!--data-lightbox="image-1"-->
                                <div class="image">
                                    <img itemprop="image" src="<?php echo $maloVeca_slika; ?>" class="img-responsive"
										...
										<div class="action">
											<ul class="action-buttons">
												<li class="add-cart-button">
                                                    <button class="btn btn-primary dodajuKorpuPocetna" data-id="<?php echo $ArtikalId ?>" data-kol="1" ><i class="fa fa-shopping-cart"></i></button>
												</li>
												<li class="view-product"><a class="btn btn-primary" href="<?php echo $urlArtiklaLink; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
                                                <li>
                                                    <button class="btn btn-primary compare dodajkompare" data-id="<?php echo $ArtikalId; ?>" title="<?php echo $jsonlang[74][$jezikId]; ?>">
