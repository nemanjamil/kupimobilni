...
(SELECT IF(K.KomitentRabat>0,K.KomitentRabat,0)/100*A.ArtikalMPCena) AS mpjac,
  ...
  JOIN KategImeZdravlje KIZ
      ON KIZ.IdKategZdravlje = KZ.KategorijaArtikalaIdZdravlje
  JOIN brendovi BR
			...
			<div class="product">
				<div class="product-image">
					<a href="<?php echo $urlArtiklaLink; ?>" > <!--data-lightbox="image-1"-->
						<div class="image">
							<img src="<?php echo $srednja_slika; ?>"  class="img-responsive" alt="">
						</div>
					...
					<div class="action">
						<ul class="list-unstyled">
							<li class="add-cart-button">
								<a class="btn btn-primary" href="<?php echo $urlArtiklaLink; ?>"><?php echo $jsonlang[76][$jezikId]; ?></a>
							</li>
							...
							<li>
								<a class="btn btn-primary compare dodajkompare" href="#" data-id="<?php echo $ArtikalId;  ?>" title="<?php echo $jsonlang[74][$jezikId]; ?>">
