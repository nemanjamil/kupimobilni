...
<div role="tabpanel" class="tab-pane fade" id="product-review" >
    ...
    <!--Zvezdice sa leve i opis sa desne strane-->
    <div class="uvuciocenu clearfix" >
        ...
        SELECT
          ...
          KD.KolikoDugoTabelaOpis" . $jezik . ", KO.KomitentIme, KO.KomitentPrezime, KO.KomitentUserName, KO.KomitentEmail
        FROM recenzije s1
        ...
        if ($data) {
            foreach ($data as $key => $val) {
                ...
                <!--Zvezdice sa leve i opis sa desne strane-->
                <div class="jednaocena col-md-8">

                    <!--Zvezdice levo-->
                    <div class="floatleft col-md-6 col-xs-5 ">
                        <div class="clearfix podvucenoukupc">
                            <div class="floatleft ovojukupnaoc"><strong><?php echo $jsonlang[315][$jezikId]; ?></strong>
                            </div>
                            <div class="floatleft">
                                <?php for ($i = 1; $i <= 5; $i++) { ?>
                    ...
                    <!--Opis desno-->
                    <div class="floatleft col-md-6 col-xs-7  desnoopisza no-padding">
                        <h3><?php echo $naslov; ?></h3>

                        <div class="bojasiva666">
                            <?php echo $jsonlang[321][$jezikId] . ': <strong>' . $ime . ' ' . $prezime .'</strong>
                            <br>' . $jsonlang[231][$jezikId] . ' :  ' . $datum_clanka; ?>
                        </div>
        ...
        if ($vroj){
            ?>
            <!--Oceni artikal-->
            <div class="col-md-4 col-xs-12 navbar-nav padding-10-10 textcentar">


                <div class="list-group ">
                    <a href="/ocene" target="_blank"
                       class="list-group-item basic-alert "><?php echo $jsonlang[319][$jezikId]; ?></a>
                    <a rel="nofollow" target="_blank" href="/ocene/<?php echo $id; ?>"
                       class="list-group-item basic-alert "><?php echo $jsonlang[318][$jezikId]; ?> </a>
                    <?php if ($KomitentUserName) {
                        $a = '<a rel="nofollow" target="_blank" href="/p/str/mojerecenzije/' . $KomitentUserName . '" class="list-group-item basic-alert">' . $jsonlang[298][$jezikId] . ' </a>';
                    }
                    echo $a;
                    ?>
    ...
    <?php
    //ukoliko nema ocenu - budi prvi koji ce oceniti proizvod
    if(!$data){
