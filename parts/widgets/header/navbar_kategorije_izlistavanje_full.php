...
if ($katspGlavne) {
    foreach ($katspGlavne AS $kay => $value) {
            ...
            $prikaz .= '<li>';
                ...
                $prikaz .= '<div class="yamm-content">';
                    $prikaz .= '<div class="row">';
                        $prikaz .= '<div class="col-xs-12">';

         $upitKateg2 = "CALL listaKategorijaPoParent($KategorijaArtikalaIdMM,$var_user,$jez_trenutni,0,9)";
      ...
      $upitPodKateg = "SELECT A.*, ANN.OpisArtikla, SL.ImeSlikeArtikliSlike FROM artikli A
                         ...
                         JOIN artikalnazivnew ANN ON ANN.ArtikalId = A.ArtikalId AND ANN.IdLanguage = 5
                         WHERE $podInUpitu
                         A.ArtikalMPCena > 0
