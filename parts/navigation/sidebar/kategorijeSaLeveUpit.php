<?php
$kaL = '';
$upitKateg = "CALL listaKategorijaPoListiId('".KATEGORIJESAJT."',$tipUsera,0,25)";
...
if ($katspGlavne){
    foreach ($katspGlavne AS $kay => $val) {
        ...
        $kaL .= '<a data-toggle="dropdown" class="dropdown-toggle visina40" href="/'.$KategorijaArtikalaLinkMM.'">'.$KategorijaArtikalaNazivMM.'</a>';
        ...
        for($i=0;$i<$kolikoRed;$i++) {
            ...
            $upitKateg = "CALL listaKategorijaPoParent($KategorijaArtikalaIdMM,$tipUsera,$limP,$limK)";
            ...
            if ($katspGlavne) {
                ...
                foreach ($katspGlavne AS $kay => $val) {
                    ...
                    $KategorijaArtikalaNazivMM2 = $val['Kat'.$jezik];
