...
$xmlLokacija = DCROOT . '/xml/3gStoreProizvodjacPovez.xml';
$dom = new DOMDocument();
$dom->load($xmlLokacija, LIBXML_NOWARNING);
$tables = $dom->getElementsByTagName('proizvodjacpovez');
        ...
        foreach ($tables as $row) {
            ...
            if ($upit1) {
                ...
                if ($ArtikalId) {
                    ...
                    $udate_artikal = Array(
                        'ArtikalProizvodjacId' => $BrendIdUpit
                ...
                echo '</br>';
                echo '<b class="bojacrvenasajt">Nemamo PROIZVODjACA u bazi, nije moguc update! <i class="bojaljubsajta"> Proizvodjac Link: '.$BrendLink.'</i></b>';
                echo '</br>';
