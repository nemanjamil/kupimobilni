<?php
	...
	$mcImageManagerConfig['SessionAuthenticator.user_key'] = "FileManager_UserName";
	// General filesystem options
	$mcImageManagerConfig['filesystem'] = "Moxiecode_LocalFileImpl";
	$mcImageManagerConfig['filesystem.path'] = '../../../pic'; //$_SERVER['DOCUMENT_ROOT'].'/pic'; //''; // absolute or relative from this script path, optional. '../../../pic';
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../pic'; //$_SERVER['DOCUMENT_ROOT'].'/pic'; // '../../../pic'; // absolute or relative from this script path, required.
