<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../f'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../f'; // absolute or relative from this script path.
